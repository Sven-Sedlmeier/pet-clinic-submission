# Documentation: Build a Github Actions pipeline
## Objectives
1) Compile the code
...
4) Publish the image to jFrog Artifactory

5) Make sure all dependencies are resolved from Maven Central

6) XRay Scan Data export (JSON format) for your image

## Execution

### Fork the Github petclinic project
...
### Push Docker image to jFrog Artefactory
